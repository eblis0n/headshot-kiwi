 ...
 * @version: 1.0.0
 * @Author: Eblis
 * @Date: 2025-05-16 14:19:42
 * @LastEditTime: 2025-05-16 14:28:17
 */
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      >
        ...
        >
          <path
            fill="url(#lovable-logo-text-light_svg__a)"
            fillRule="evenodd"
            d="M5.904 0c3.26 0 5.904 2.65 5.904 5.92v2.25h1.965c3.26 0 5.904 2.65 5.904 5.92 0 3.268-2.643 5.919-5.904 5.919H0V5.919C0 2.65 2.643 0 5.904 0"
            clipRule="evenodd"
          />
        </mask>
        ...
        <defs>
          <filter
            id="lovable-logo-text-light_svg__c"
            width="38.578"
            height="38.579"
            x="-10.658"
            y="-8.609"
          ...
          >
            ...
            <feGaussianBlur result="effect1_foregroundBlur_19187_11610" stdDeviation="2.985" />
          </filter>
          <filter
            id="lovable-logo-text-light_svg__d"
            width="46.057"
            height="38.579"
            x="-12.934"
            y="-15.918"
          ...
          <filter
            id="lovable-logo-text-light_svg__e"
            width="38.578"
            height="35.334"
            x="-6.412"
            y="-16.803"
          ...
          <filter
            id="lovable-logo-text-light_svg__f"
            width="27.96"
            height="27.96"
            x="-3.648"
            y="-10.613"
          ...
          <linearGradient
            id="lovable-logo-text-light_svg__a"
            x1="6.622"
            x2="12.617"
            y1="3.516"
            y2="20.001"
      ...
      >
        ...
        >
          <path
            fill="url(#lovable-logo-text-dark_svg__a)"
            fillRule="evenodd"
            d="M5.904.885c3.26 0 5.904 2.65 5.904 5.92v2.25h1.965c3.26 0 5.904 2.65 5.904 5.92s-2.643 5.919-5.904 5.919H0V6.804C0 3.536 2.643.886 5.904.886"
            clipRule="evenodd"
          />
        </mask>
        <g mask="url(#lovable-logo-text-dark_svg__b)">
          <g filter="url(#lovable-logo-text-dark_svg__c)">
            <circle cx="8.632" cy="11.566" r="13.32" fill="#4B73FF" />
          </g>
          <g filter="url(#lovable-logo-text-dark_svg__d)">
            <ellipse cx="10.095" cy="4.256" fill="#FF66F4" rx="17.059" ry="13.32" />
          </g>
          <g filter="url(#lovable-logo-text-dark_svg__e)">
            <ellipse cx="12.877" cy="1.75" fill="#FF0105" rx="13.32" ry="11.698" />
          </g>
          <g filter="url(#lovable-logo-text-dark_svg__f)">
            <circle cx="10.332" cy="4.253" r="8.011" fill="#FE7B02" />
          </g>
        </g>
        <defs>
          <filter
            id="lovable-logo-text-dark_svg__c"
            width="38.579"
            height="38.579"
            x="-10.658"
            y="-7.724"
          ...
          >
            <feFlood floodOpacity="0" result="BackgroundImageFix" />
            <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur result="effect1_foregroundBlur_19703_15608" stdDeviation="2.985" />
          </filter>
          <filter
            id="lovable-logo-text-dark_svg__d"
            width="46.057"
            height="38.579"
            x="-12.934"
            y="-15.033"
          ...
          <filter
            id="lovable-logo-text-dark_svg__e"
            width="38.579"
            height="35.334"
            x="-6.412"
            y="-15.918"
          ...
          <filter
            id="lovable-logo-text-dark_svg__f"
            width="27.96"
            height="27.96"
            x="-3.648"
            y="-9.727"
          ...
          <linearGradient
            id="lovable-logo-text-dark_svg__a"
            x1="6.622"
            x2="12.617"
            y1="4.401"
            y2="20.886"
